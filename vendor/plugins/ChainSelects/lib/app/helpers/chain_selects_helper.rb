module ChainSelectsHelper
  ...
  def chain_select_options(model_name, prefix)
    ...
    {:onchange => "new Ajax.Request('/chain_selects/query/' + this.value + '?parent=#{model_name}&prefix=#{prefix}', {asynchronous:true, evalScripts:true}); return false;", :class => 'chain_select_boxes'}
  end
  # 
